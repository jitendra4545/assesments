...
import { addCustomer, addSupplier, getCustomer, getSupplier } from '../redux/action'
...
if(PartyName=="" || PhoneNo==""||Address==""){
    ...
    dispatch(addSupplier(GSTIN,PartyName,PhoneNo,Address)).then(()=>{
    ...
    return (
        <div>
            <div class="py-3 px-3 flex"><h1 class='text-4xl font-light '>Add Supplier</h1></div>
